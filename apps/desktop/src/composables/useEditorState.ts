...
export function useEditorState(
  ...
  const canvasScene = computed(() => {
    ...
    return sceneProjector.project(snapshot, { signals }, previewPositions.value, routeEditPreview.value ? { [routeEditPreview.value.connectionId]: routeEditPreview.value.route } : undefined);
  });
